...
<label for="">Date de Naissance</label>
      ...
      <td><select  name="liste1" onChange="affichersection()" value=" <?php echo $Section; ?>">
      	<option value="kind"> Kindergarden</option>
      	<option value="fond"> Fondamentale</option>
      	<option value="sec"> Nouveau Secondaire</option>
      	</select></td>
      <br><br>
      ...
      <select name="liste" onChange="afficherAutre()" value="<?php echo $Lien_parente; ?>">
